...
<div class="ui stackable grid" id="suggestions">
    <div class="ui centered row">
        <div class="ui ten wide tablet twelve wide computer column">
		  ...
		  {if isset($SUGGESTIONS_LIST)}
			<table class="ui fixed single line selectable unstackable small padded res table" style="padding: 1em 0 2em;">
			  <thead>
				<tr>
			...
			{$PAGINATION}	
		  {else}
			<p style="margin-top:2em;color:rgba(var(--text-color),.5);">{$NO_SUGGESTIONS}</p>
		  {/if}
