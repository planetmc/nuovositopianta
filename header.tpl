...
<html{$HTMLCLASS}{$HTMLLANG}{$HTMLRTL}>
    ...
    <head>
      ...
      <style>
        :root, :before, :after, .dark, .dark :before, .dark :after {
               {if isset($primaryColor)}
               --default-primary-color: {$primaryColor};
               --primary-color: {$primaryColor};
                {/if}
                {if isset($primaryButtonColor)}
               --primary-button-color: {$primaryButtonColor};
                {/if}
                {if isset($bannerColor) && isset($bannerOpacity)}
               --banner-color: {$bannerColor} , {$bannerOpacity};
               --second-banner-color: {$bannerColor} , {$bannerOpacity};
                {/if}
                {if isset($iconColor)}
               ...
               --icon-background-color: {$iconBackgroundColor};
                {/if}
                {if isset($newsColor)}
               --news-background-color: {$newsColor};
                {/if}
