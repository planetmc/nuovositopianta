          ...
          <tbody>
            {foreach from=$SUBFORUMS item=subforum}
              <tr>
                <td>
                  <h5 class="ui header">
                    {if empty($subforum.icon)}<img class="ui mini circular image" src="https://cravatar.eu/helmavatar/{$discussion.topic_created_username}/128.png">{else}{$subforum.icon}{/if}
                    <div class="content">
                      ...
                      <h5 class="ui header">
                        ...
                        <div class="content">
                          ...
                          <div class="ui wide popup">
                            ...
                            <br/>{$BY|capitalize} <a href="{$subforum.latest_post.last_user_link}">{$subforum.latest_post.last_user}</a>
                            | {$subforum.latest_post.time}
                          </div>
                          <div class="sub header">
                            <a href="{$subforum.latest_post.last_user_link}" data-poload="{$USER_INFO_URL}{$subforum.latest_post.last_user_id}">{$subforum.latest_post.last_user}</a> &middot; <span data-toggle="tooltip" data-content="{$subforum.latest_post.time}">{$subforum.latest_post.timeago}</span>
                          </div>
                        </div>
                      </h5>
                    {else}
          ...
          <tbody>
            {foreach from=$STICKY_DISCUSSIONS item=discussion}
              <tr>
                <td>
                  <h5 class="ui header">
                    <img class="ui mini circular image" src="https://cravatar.eu/helmavatar/{$discussion.topic_created_username}/128.png">
                    <div class="content">
                      ...
                      <div class="ui wide popup">
                        ...
                        {$BY|capitalize} <a href="{$discussion.author_link}"  >{$discussion.topic_created_username}</a> | {$discussion.topic_created}
                      </div>
                      <div class="sub header">
                        <a href="{$discussion.author_link}" data-poload="{$USER_INFO_URL}{$discussion.topic_created_user_id}">{$discussion.topic_created_username}</a> &middot; <span data-toggle="tooltip" data-content="{$discussion.topic_created}">{$discussion.topic_created_rough}</span>
                      </div>
                   </div>
                  </h5> 
                </td>
                ...
                <td>
                  <h5 class="ui image header">
                    ...
                    <div class="content">
                      <a href="{$discussion.last_reply_link}" data-toggle="popup" data-poload="{$USER_INFO_URL}{$discussion.last_reply_user_id}">{$discussion.last_reply_username}</a>
