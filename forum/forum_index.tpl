...
<div class="ui stackable padded grid" id="forum-index">
    <div class="ui centered row">
        <div class="ui eleven wide tablet twelve wide computer column" style="display:flex;align-items:center;">
            <div class="ui breadcrumb" style="height:fit-content;">
...
<div class="ui stackable padded grid" id="forum-index">
    <div class="ui centered row">
        ...
        <div
            ...
            <div class="ui padded segment" id="forum-header">
                                    ...
                                    <div class="centered row">
                                        <div class="nine wide column">
                                            ...
                                            <div class="description">
                                                <span><i class="fas fa-comment-alt"></i>{$subforum->topics}</span>
                                                 <span><i class="fas fa-comment"></i>{$subforum->posts}</span>
                                                {if isset($subforum->subforums)}
                                        ...
                                        <div class="six wide column mobile hidden">
                                            {if isset($subforum->last_post)}
                                                ...
                                                <div class="ui wide popup">
                                                    ...
                                                    <br/>{$BY|capitalize} <a href="{$subforum->last_post->profile}">{$subforum->last_post->username}</a>
